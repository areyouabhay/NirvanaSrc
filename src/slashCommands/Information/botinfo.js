const { EmbedBuilder, CommandInteraction, Client, version } = require("discord.js");
const NirvanaClient = require("../../structures/Client");
require("moment-duration-format");
module.exports = {
    name: "botinfo",
    description: "Displays the bot's infopage.",
    /**
     * 
    ...
    run: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`Hey **${interaction.member.user.username}**, I'm Nirvana, a quality music bot which makes you feel the Music and it's Beats
